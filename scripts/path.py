    ...
    def __init__(self, triple='simple'):
        ...
        if triple == 'simple':
            ...
            for i in range(3.0, 12.1, path_width):
                ...
                self.path.append(easy_Odom(x=2.25+path_width, y=i+path_width/2, v=0.5, heading=pi/2, frame='map')) # 2
                self.path.append(easy_Odom(x=4.75-path_width, y=i+path_width/2, v=0.5, heading=pi/2, frame='map')) # 3
                self.path.append(easy_Odom(x=4.75, y=i-path_width/2, v=0.5, heading=pi/2, frame='map')) # 4
                self.path.append(easy_Odom(x=4.75-path_width, y=i-3*path_width/2, v=0.5, heading=pi/2, frame='map')) # 5
                self.path.append(easy_Odom(x=2.25+2*path_width, y=i-3*path_width/2, v=0.5, heading=pi/2, frame='map')) # 6
